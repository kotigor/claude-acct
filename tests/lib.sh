...
t_setup() {
  ...
  unset CLAUDE_CONFIG_DIR CLAUDE_SECURESTORAGE_CONFIG_DIR CLAUDE_CODE_CUSTOM_OAUTH_URL \
    ...
    CLAUDE_CODE_NO_FLICKER TERM_PROGRAM DISPLAY WAYLAND_DISPLAY XDG_CONFIG_HOME TERMINAL_EMULATOR \
    INTELLIJ_TERMINAL_COMMAND_BLOCKS INTELLIJ_TERMINAL_COMMAND_BLOCKS_REWORKED \
    FIG_TERM PROCESS_LAUNCHED_BY_CW PROCESS_LAUNCHED_BY_Q
